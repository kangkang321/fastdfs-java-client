...
/**
 * 大文件上传，先用这个上传，后续的用AppendFileCmd
 * 
 * @author admins(admins@rogrand.com)
 * @version 2016年8月9日 上午10:41:26
 */
public class UploadAppenderFileCmd extends AbstractCmd<String[]> {

	private FileInputStream file;
	private String fileExtName;

	public UploadAppenderFileCmd(FileInputStream file, String fileExtName) {
		this.file = file;
	...
	protected void doRequest(Channel channel) throws Exception {
		...
		header = ProtoCommon.packHeader(ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_APPENDER_FILE, body_len, (byte) 0);
